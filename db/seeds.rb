...
Accessory.create(name: "helmet", description: "awesome lightning blue helmet - makes ya look cool!", price: 34.99, image_path: 'bike.png', status: "active")
Accessory.create(name: "tights", description: "aerodynamic tights - make ya go fast!", price: 55.99, image_path: 'bike.png', status: "active")
Accessory.create(name: "clip in shoes", description: "lock in to your pedals and leave your competitors in the dust!", price: 110.99, image_path: 'bike.png', status: "active")
Accessory.create(name: "bike pump", description: "portable bike pump for inflating on the go", price: 20.00, image_path: 'bike.png', status: "active")
Accessory.create(name: "water bottle", description: "hydrate on the go!", price: 8.50, image_path: 'bike.png', status: "active")
Accessory.create(name: "tubes", description: "bring them in case you get a flat!", price: 5.25, image_path: 'bike.png', status: "active")
Accessory.create(name: "rims", description: "got some 20s for the street cred", price: 22.15, image_path: 'bike.png', status: "active")
Accessory.create(name: "tires", description: "street tires that are sleak", price: 15.50, image_path: 'bike.png', status: "active")
Accessory.create(name: "mountain bike", description: "you could go down Everest in this thing", price: 1150.00, image_path: 'bike.png', status: "active")
Accessory.create(name: "road bike", description: "the ferrari of road bikes!", price: 1750.00, image_path: 'bike.png', status: "active")
Accessory.create(name: "beach bike", description: "california dreaming...", price: 639.00, image_path: 'bike.png', status: "active")
Accessory.create(name: "fixie", description: "comes with a free fist tat!", price: 542.00, image_path: 'bike.png', status: "active")
