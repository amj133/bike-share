...
Accessory.create(name: "helmet", description: "awesome lightning blue helmet - makes ya look cool!", price: 3450)
Accessory.create(name: "tights", description: "aerodynamic tights - make ya go fast!", price: 5599)
Accessory.create(name: "clip in shoes", description: "lock in to your pedals and leave your competitors in the dust!", price: 11099)
Accessory.create(name: "bike pump", description: "portable bike pump for inflating on the go", price: 2000)
Accessory.create(name: "water bottle", description: "hydrate on the go!", price: 850)
Accessory.create(name: "tubes", description: "bring them in case you get a flat!", price: 525)
Accessory.create(name: "rims", description: "got some 20s for the street cred", price: 2215)
Accessory.create(name: "tires", description: "street tires that are sleak", price: 1550)
Accessory.create(name: "mountain bike", description: "you could go down Everest in this thing", price: 115000)
Accessory.create(name: "road bike", description: "the ferrari of road bikes!", price: 175000)
Accessory.create(name: "beach bike", description: "california dreaming...", price: 63900)
Accessory.create(name: "fixie", description: "comes with a free fist tat!", price: 54200)
