...
Accessory.create(name: "bike pump", description: "portable bike pump for inflating on the go", price: 2000, image_path: 'bike.png')
Accessory.create(name: "water bottle", description: "hydrate on the go!", price: 850, image_path: 'bike.png')
Accessory.create(name: "tubes", description: "bring them in case you get a flat!", price: 525, image_path: 'bike.png')
Accessory.create(name: "rims", description: "got some 20s for the street cred", price: 2215, image_path: 'bike.png')
Accessory.create(name: "tires", description: "street tires that are sleak", price: 1550, image_path: 'bike.png')
Accessory.create(name: "mountain bike", description: "you could go down Everest in this thing", price: 115000, image_path: 'bike.png')
Accessory.create(name: "road bike", description: "the ferrari of road bikes!", price: 175000, image_path: 'bike.png')
Accessory.create(name: "beach bike", description: "california dreaming...", price: 63900, image_path: 'bike.png')
Accessory.create(name: "fixie", description: "comes with a free fist tat!", price: 54200, image_path: 'bike.png')
