...
describe "user visits trip dashboard" do
  it "displays trip analytics" do
    ...
    expect(page).to have_content(Trip.longest_ride.formatted_duration)
    expect(page).to have_content(Trip.shortest_ride.formatted_duration)
  ...
  it "displays weather stats for longest and shortest rides" do
    ...
    expect(page).to have_content("Weather averages during the shortest ride:")
