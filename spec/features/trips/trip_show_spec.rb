require 'rails_helper'
  ...
  describe "user visits trip show page" do
    ...
    trip = Trip.create!(duration: 73, start_date: DateTime.new(2001, 9 ,11), start_station_id: 1,
...
describe "user visits trip show page" do
  ...
  trip = Trip.create!(duration: 23, start_date: DateTime.new(2001, 9, 11), start_station_id: 1,
  end_date: DateTime.new(2001, 9, 12), end_station_id: 1, bike_id: 23, subscription: "Subscriber",
  zipcode: 80205)
